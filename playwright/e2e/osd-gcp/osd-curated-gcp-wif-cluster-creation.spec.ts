...
test.describe.serial(
  ...
  () => {
    ...
    test(`OSD curated wizard - ${clusterProperties.CloudProvider} -${clusterProperties.AuthenticationType} : Billing model`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD GCP curated wizard - ${clusterProperties.CloudProvider} -${clusterProperties.AuthenticationType} : Cluster Settings - Cloud provider definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD GCP curated wizard - ${clusterProperties.CloudProvider} -${clusterProperties.AuthenticationType} -${clusterProperties.Marketplace} : Cluster Settings - Cluster details definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD GCP curated wizard - ${clusterProperties.CloudProvider} -${clusterProperties.AuthenticationType} -${clusterProperties.Marketplace} : Cluster Settings - Default machinepool definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD GCP curated wizard - ${clusterProperties.CloudProvider} -${clusterProperties.Marketplace} : VPC Settings definitions`, async ({
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD GCP curated wizard - ${clusterProperties.CloudProvider} -${clusterProperties.AuthenticationType} -${clusterProperties.Marketplace} : Networking configuration - CIDR ranges definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD GCP curated wizard - ${clusterProperties.CloudProvider} -${clusterProperties.AuthenticationType} -${clusterProperties.Marketplace} : Cluster updates definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD GCP curated wizard - ${clusterProperties.CloudProvider} -${clusterProperties.AuthenticationType} -${clusterProperties.Marketplace} : Review and create page definitions`, async ({
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD GCP curated wizard - ${clusterProperties.CloudProvider} -${clusterProperties.AuthenticationType} -${clusterProperties.Marketplace} : Cluster submission & overview definitions`, async ({
      createOSDWizardPage,
      clusterDetailsPage,
    }) => {
